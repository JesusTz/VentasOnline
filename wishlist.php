...
<section class="products">
   ...
   <form action="" method="post" class="box">
      ...
      <input type="submit" value="Eliminar Producto" onclick="return confirm('¿Eliminar de la lista de Deseo?');" class="delete-btn" name="delete">
   </form>
   <?php
      }
   }else{
   ...
   <div class="wishlist-total">
      <p>Grand Total : <span>$<?= $grand_total; ?> mxn</span></p>
