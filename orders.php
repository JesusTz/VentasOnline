...
<section class="orders">
   ...
   ?>
   <div class="box">
      <p>Realizado en: <span><?= $fetch_orders['placed_on']; ?></span></p>
      ...
      <p>Precio Total : <span>$<?= $fetch_orders['total_price']; ?> mxn</span></p>
      <p>Estatus de Pago : <span style="color:<?php if($fetch_orders['payment_status'] == 'Pendiente'){ echo 'red'; }else{ echo 'green'; }; ?>"><?= $fetch_orders['payment_status']; ?></span> </p>
   </div>
   <?php
      }
      }else{
