...
<header class="header">
   ...
   <section class="flex">
      ...
      <a href="home.php" class="logo">SpNova<span> Valladolid</span></a>

      <nav class="navbar">
         <a href="home.php">Inicio</a>
         <a href="about.php">Categorias</a>
      ...
      <div class="profile">
         ...
         <a href="components/user_logout.php" class="delete-btn" onclick="return confirm('Salir de tu Perfil?');">Salir</a> 
         <?php
            }else{
         ?>
