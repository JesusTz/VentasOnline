...
<section class="products">
   ...
   <?php
     if(isset($_GET['category'])) {
        ...
        $select_products = $conn->prepare("SELECT p.* FROM `products` p INNER JOIN `categorias` c ON p.Id_Cat = c.id_cat WHERE c.categoria = :category");
   ...
   <?php
        ...
        echo '<p class="empty">¡No se ha seleccionado ninguna categoría!</p>';
    }
   ?>
